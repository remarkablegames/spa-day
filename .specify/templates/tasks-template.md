...
**Tests**: The examples below include gameplay testing tasks. Manual gameplay testing is REQUIRED for all game features - automated testing is optional but encouraged for utility functions.
